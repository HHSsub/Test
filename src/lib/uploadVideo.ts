import { supabase, STORAGE_BUCKET, VIDEOS_FOLDER, getPublicUrl, CACHE_CONTROL_HEADER } from './supabase';
 ...
 * @param folder - Subfolder within videos folder (optional)
